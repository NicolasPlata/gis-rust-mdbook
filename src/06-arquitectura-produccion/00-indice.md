...
El servidor cloud-native v0.4 completo (Módulo 4) y, en particular, el `Result`/manejo de errores del Módulo 1 (2.2) — este módulo lo lleva a su conclusión lógica: qué le devuelves exactamente a un cliente HTTP cuando algo falla.
