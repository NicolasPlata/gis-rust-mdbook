...
`geoapi-core` completo (Módulo 2) — este módulo lo extiende directamente, nunca lo reescribe. También ayuda haber interiorizado por qué `Result` importa (2.2): las consultas a PostGIS y las reproyecciones fallan de formas muy concretas que vas a tener que propagar bien.
